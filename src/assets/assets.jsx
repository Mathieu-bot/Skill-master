...
const assets = {
    ...
    graduationIconWhite: (
        <svg 
            className="w-[22px] h-[22px] dark:text-gray-800 text-white" 
            aria-hidden="true" 
            xmlns="http://www.w3.org/2000/svg" 
            width="24" 
            height="24" 
    ...
    computerVision: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19.5 10c0 6.075-4.925 11-11 11S2.5 16.075 2.5 10 7.425 4 13.5 4s6 6.075 6 6z" />
        </svg>
    ),
    voiceAI: (
    ...
    // Ajout des icônes manquantes pour le dashboard
    voice: (
        <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 11a7 7 0 01-7 7m0 0a7 7 0 01-7-7m7 7v4m0 0H8m4 0h4m-4-8a3 3 0 01-3-3V5a3 3 0 116 0v6a3 3 0 01-3 3z" />
        </svg>
  ...
  <path d="m19.821 8.605-2.857 2.857a4.952 4.952 0 0 1-5.514 5.514l-1.785 1.785c.767.166 1.55.25 2.335.251 6.453 0 10-5.258 10-7 0-1.166-1.637-2.874-2.179-3.407Z"/>
    ...
    isLoadingIcon: (<svg className="animate-spin h-5 w-5 dark:text-white text-gray-900" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
